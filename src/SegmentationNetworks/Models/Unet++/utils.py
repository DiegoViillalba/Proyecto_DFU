...
def plot_dice_loss(L_dice_result, L_loss_result, show_plot=False):
    ...
    plt.savefig("output_assets_model/dice_loss_graph_UnetPlusPlus.png")
    print(f"Gráfica de Loss y Dice guardada en: output_assets_model/dice_loss_graph_UnetPlusPlus.png")
